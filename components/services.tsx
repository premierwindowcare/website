...
export function Services() {
  const services = [
    ...
    },
    {
      icon: Square,
      title: "Frames",
      description: "Detailed frame wiping to remove dust and buildup for a polished look.",
    },
    {
      icon: Layers,
      title: "Sills",
      description: "Thorough sill cleaning to eliminate dirt and leave everything spotless.",
    },
  ]
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-pale/40 via-blue-light/30 to-blue-sky/20 p-8 md:p-10 border border-blue-light/40 shadow-xl">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 bg-blue-primary/10 rounded-full px-4 py-1.5 mb-4">
                ...
                <span className="text-sm font-medium text-blue-primary">Included With Service</span>
              </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="h-40 md:h-48 bg-gradient-to-br from-blue-pale/50 via-blue-light/30 to-blue-sky/20 flex items-center justify-center">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-primary to-blue-sky flex items-center justify-center transition-transform group-hover:scale-110">
